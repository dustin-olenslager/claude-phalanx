...
The supervisor runs each pass in its own git worktree (`claude --worktree`), so your checkout is isolated from the primary tree and from other passes. Three rules:
