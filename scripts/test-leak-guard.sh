...
r=$(mkrepo "ip 10.0.0.1");      ck "private-skips"        "$(run "$r" https://github.com/owner/secret.git)" 0; rm -rf "$r"
r=$(mkrepo "ip 10.0.0.1");      ck "public-universal-block" "$(run "$r" https://github.com/owner/plexo.git)" 1; rm -rf "$r"
